...
var BubbleChart = function (_Component) {
  ...
  _createClass(BubbleChart, [{
    ...
    value: function render() {
      ...
      this.svg = (0, _react.createRef)();
      return _react2.default.createElement('svg', { width: width, height: height, ref: this.svg });
    }
  }, {
    key: 'renderChart',
    ...
    value: function renderBubbles(width, nodes, color) {
      ...
      var bubbleChart = d3.select(this.svg.current).append("g").attr("class", "bubble-chart").attr("transform", function (d) {
    ...
    value: function renderLegend(width, height, offset, nodes, color) {
      ...
      var legend = d3.select(this.svg.current).append("g").attr("transform", function () {
